...
export default {
  ...
  'request.oldShell': 'New app version – please close and reopen the app',
  ...
  'auth.oldShell': 'New app version – please close and reopen the app, then sign in',
  ...
  'auth.badLegacyPassword': 'Wrong old password',
  ...
  'entries.sealTooMany': 'At most {max} entries per request',
};
